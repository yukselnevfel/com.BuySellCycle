...
public class VisitorHomePageStepDef extends Base {
    ...
    public void verify_that_the_is_visible(String string) {assertTrue(visitorHomePage.linkHeaderBlog.isDisplayed());
    }

    @Given("Verify that the {string} is active")
    public void verify_that_the_is_active(String string) {
