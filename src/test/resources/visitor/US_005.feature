...
Feature: As a user, I would like to be able to log in with the email and password I registered with the site.
  ...
  * Close the page
  ...
  @login
  Scenario: User should be login with Valid email and valid password.
  * Click on the login link, Enter "aycaCustomerEmail" and "password" and click sign in
  * Close the page

  Scenario: With Valid PHONE NUMBER and password are entered and the Sign In button is clicked, the system should log in
